...
Давайте возьмем шаблонный код сверху и превратим его в модуль, разделив на несколько файлов. Я покажу модульный паттерн, который работает с любым браузерным или серверным кодом (или работает и там, и там). Назовем наш новый файл `"formuploader.js"` он содержит в себе две фунции:
